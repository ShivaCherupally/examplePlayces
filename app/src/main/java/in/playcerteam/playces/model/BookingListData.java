...
public class BookingListData {
    ...
    private String courtCancelled;
    private int isOpened;      //This is For Show item on this screen

    /*public BookingListData() {
    }*/

    /*public BookingListData(String sportsId, String sportsName, String bookingId, String bookedDate, String slotTime, String courtName,
                           String booking_source, String amount_paid, String is_amount_paid, String payment_mode, String bookingCancelled, String courtCancelled, int isOpened) {
        ...
        this.courtCancelled = courtCancelled;
    ...
    //bookingCancelled
    public void set_bookingCancelled(String bookingCancelled) {
        this.bookingCancelled = bookingCancelled;
    }

    public String get_bookingCancelled() {
        return bookingCancelled;
    }

    //courtCancelled
    public void set_CourtCancelled(String courtCancelled) {
        this.courtCancelled = courtCancelled;
    }

    public String get_courtCancelled() {
        return courtCancelled;
    }
