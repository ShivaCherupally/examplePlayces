...
public class AvailableListFragment extends Activity {
    ...
    String TodayDateFinal;

    Date todaydateAndTime;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        currentDayAndDateSet(mYear, mMonth, mDay, "");
        todayCalender = Calendar.getInstance();

        todaydateAndTime = new Date(System.currentTimeMillis());

        try {
            SimpleDateFormat sdftemp = new SimpleDateFormat("dd-M-yyyy");
            int tempYear = c.get(Calendar.YEAR);
            int tempMonth = c.get(Calendar.MONTH);
            int tempDay = c.get(Calendar.DAY_OF_MONTH);
            /*String tempTodayDateFinal = Integer.toString(tempYear) + "-" + "0" + Integer.toString(tempMonth + 1) + "-" + Integer.toString(tempDay);
            presentdate = sdftemp.parse(tempTodayDateFinal);
            String tempdaydate = (String) android.text.format.DateFormat.format("dd", presentdate);
            String tempmonthNo = (String) android.text.format.DateFormat.format("MM", presentdate);
            TodayDateFinal = tempYear + "-" + tempmonthNo + "-" + tempdaydate;*/
            String dateInString = Integer.toString(tempDay) + "-" + "0" + Integer.toString(tempMonth + 1) + "-" + Integer.toString(tempYear);
            ...
            TodayDateFinal = mYear + "-" + monthNo + "-" + daydate;
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        prevousDateTVID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if (!TodayDateFinal.equals(Todaydate)) { // click Event here
                //monthAndDayNamesFetch(mYear, mMonth, mDay, previousDateStr);
                //}
                previousDateNamesFetch(mYear, mMonth, mDay, previousDateStr);
        ...
        nextDayTVID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                nextDateNamesFetch(mYear, mMonth, mDay, previousDateStr);
               // monthAndDayNamesFetch(mYear, mMonth, mDay, previousDateStr);
            }
        });
        ...
        sportsSPID.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View view, int arg2, long arg3) {
                ...
                SharedPreference.setPreference(getApplicationContext(), "KEY_SPORT_ID", sports_id);
                ...
                if (Utility.isOnline(AvailableListFragment.this)) {
    ...
    private void confirmaingCourtsToServer() {

        if (Utility.isOnline(getApplicationContext())) {
            if (selectedStrings.size() != 0) {
                if (todaydateAndTime.before(date)) {        //Present date Tue Jun 21 03:36:15 GMT+05:30 2016 -- Previous date//Sat Jun 18 00:00:00 GMT+05:30 2016
                    sendConfirmationRequest(AppConstants.CONFIRM_BOOKING_URL); //2016-06-21
                } else if (TodayDateFinal.equals(datestr)) {   //2016-06-22
                    Calendar now = Calendar.getInstance();
                    now.set(Calendar.HOUR_OF_DAY, 12);
                    now.set(Calendar.MINUTE, 15);
                    Calendar givenDate = Calendar.getInstance();
                    givenDate.setTime(date); //Tue Jun 21 00:00:00 GMT+05:30 2016
                    boolean isBefore = now.before(givenDate); //java.util.GregorianCalendar[time=?,areFieldsSet=false,lenient=true,zone=Asia/Calcutta,firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2016,MONTH=5,WEEK_OF_YEAR=26,WEEK_OF_MONTH=4,DAY_OF_MONTH=22,DAY_OF_YEAR=174,DAY_OF_WEEK=4,DAY_OF_WEEK_IN_MONTH=4,AM_PM=0,HOUR=0,HOUR_OF_DAY=12,MINUTE=15,SECOND=23,MILLISECOND=112,ZONE_OFFSET=19800000,DST_OFFSET=0]
                    if (isBefore) {
                       // Utility.showCustomToast("isBefore if", AvailableListFragment.this);
                        Utility.showCustomToast(getResources().getString(R.string.time_expired), AvailableListFragment.this);
                    } else {
                        sendConfirmationRequest(AppConstants.CONFIRM_BOOKING_URL); //Tue Jun 21 00:00:00 GMT+05:30 2016
                       // Utility.showCustomToast("isBefore else", AvailableListFragment.this);
                    }
                    //sendConfirmationRequest(AppConstants.CONFIRM_BOOKING_URL);
                } else {
                    Utility.showCustomToast(getResources().getString(R.string.date_expired), AvailableListFragment.this);
                }
            } else {
                Utility.showCustomToast(getResources().getString(R.string.pls_select_courts), AvailableListFragment.this);
            }
        } else {
            loadingSportsTroubleConnecting();
        }
    ...
    private void ifNetisAvilableAvailbleList() {
        sendRequestToGetAvailbleList(AppConstants.AVAILABLE_LIST_URL);
    }

    private void sendRequestToGetAvailbleList(String sportsListUrl) {
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();
        params.put("facility_id", SharedPreference.getPreferences(AvailableListFragment.this, "KEY_FACILITY_ID")); //5
        params.put("sports_id", SharedPreference.getPreferences(AvailableListFragment.this, "KEY_SPORT_ID")); //1
                                        ...
                                        if (countList != 0) {
                                            ...
                                            for (int i = 0; i < _singleAvailbleListData.size(); i++) {
                                                if (i == 0) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime1TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts1TVID.setVisibility(View.GONE);
                                                        availableCourts1TVID.setVisibility(View.GONE);
                                                        avaialable1TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts1TVID.setVisibility(View.VISIBLE);
                                                        availableCourts1TVID.setVisibility(View.VISIBLE);
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FirstRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable1TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime1TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts1TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts1TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable1TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts1TVID.setVisibility(View.VISIBLE);
                                                            availableCourts1TVID.setVisibility(View.VISIBLE);
                                                            avaialable1TVID.setVisibility(View.VISIBLE);
                                                        }
                                                ...
                                                if (i == 1) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime2TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts2TVID.setVisibility(View.GONE);
                                                        availableCourts2TVID.setVisibility(View.GONE);
                                                        avaialable2TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts2TVID.setVisibility(View.VISIBLE);
                                                        availableCourts2TVID.setVisibility(View.VISIBLE);
                                                        avaialable2TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FirstRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable2TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime2TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts2TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts2TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable2TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 2) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime3TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts3TVID.setVisibility(View.GONE);
                                                        availableCourts3TVID.setVisibility(View.GONE);
                                                        avaialable3TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts3TVID.setVisibility(View.VISIBLE);
                                                        availableCourts3TVID.setVisibility(View.VISIBLE);
                                                        avaialable3TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FirstRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable3TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime3TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts3TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts3TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable3TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 3) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime4TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts4TVID.setVisibility(View.GONE);
                                                        availableCourts4TVID.setVisibility(View.GONE);
                                                        avaialable4TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts4TVID.setVisibility(View.VISIBLE);
                                                        availableCourts4TVID.setVisibility(View.VISIBLE);
                                                        avaialable4TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SecondRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable4TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime4TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts4TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts4TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable4TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 4) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime5TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts5TVID.setVisibility(View.GONE);
                                                        availableCourts5TVID.setVisibility(View.GONE);
                                                        avaialable5TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts5TVID.setVisibility(View.VISIBLE);
                                                        availableCourts5TVID.setVisibility(View.VISIBLE);
                                                        avaialable5TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SecondRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable5TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime5TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts5TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts5TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable5TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 5) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime6TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts6TVID.setVisibility(View.GONE);
                                                        availableCourts6TVID.setVisibility(View.GONE);
                                                        avaialable6TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts6TVID.setVisibility(View.VISIBLE);
                                                        availableCourts6TVID.setVisibility(View.VISIBLE);
                                                        avaialable6TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SecondRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable6TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime6TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts6TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts6TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable6TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 6) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime7TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts7TVID.setVisibility(View.GONE);
                                                        availableCourts7TVID.setVisibility(View.GONE);
                                                        avaialable7TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts7TVID.setVisibility(View.VISIBLE);
                                                        availableCourts7TVID.setVisibility(View.VISIBLE);
                                                        avaialable7TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            ThirdRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable7TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime7TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts7TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts7TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable7TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 7) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime8TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts8TVID.setVisibility(View.GONE);
                                                        availableCourts8TVID.setVisibility(View.GONE);
                                                        avaialable8TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts8TVID.setVisibility(View.VISIBLE);
                                                        availableCourts8TVID.setVisibility(View.VISIBLE);
                                                        avaialable8TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            ThirdRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable8TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime8TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts8TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts8TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable8TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 8) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime9TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts9TVID.setVisibility(View.GONE);
                                                        availableCourts9TVID.setVisibility(View.GONE);
                                                        avaialable9TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts9TVID.setVisibility(View.VISIBLE);
                                                        availableCourts9TVID.setVisibility(View.VISIBLE);
                                                        avaialable9TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            ThirdRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable9TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime9TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts9TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts9TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable9TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 9) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime10TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts10TVID.setVisibility(View.GONE);
                                                        availableCourts10TVID.setVisibility(View.GONE);
                                                        avaialable10TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts10TVID.setVisibility(View.VISIBLE);
                                                        availableCourts10TVID.setVisibility(View.VISIBLE);
                                                        avaialable10TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FourthRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable10TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime10TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts10TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts10TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable10TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 10) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime11TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts11TVID.setVisibility(View.GONE);
                                                        availableCourts11TVID.setVisibility(View.GONE);
                                                        avaialable11TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts11TVID.setVisibility(View.VISIBLE);
                                                        availableCourts11TVID.setVisibility(View.VISIBLE);
                                                        avaialable11TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FourthRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable11TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime11TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts11TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts11TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable11TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 11) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime12TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts12TVID.setVisibility(View.GONE);
                                                        availableCourts12TVID.setVisibility(View.GONE);
                                                        avaialable12TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts12TVID.setVisibility(View.VISIBLE);
                                                        availableCourts12TVID.setVisibility(View.VISIBLE);
                                                        avaialable12TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FourthRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable12TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime12TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts12TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts12TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable12TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 12) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime13TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts13TVID.setVisibility(View.GONE);
                                                        availableCourts13TVID.setVisibility(View.GONE);
                                                        avaialable13TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts13TVID.setVisibility(View.VISIBLE);
                                                        availableCourts13TVID.setVisibility(View.VISIBLE);
                                                        avaialable13TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FifthRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable13TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime13TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts13TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts13TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable13TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 13) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime14TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts14TVID.setVisibility(View.GONE);
                                                        availableCourts14TVID.setVisibility(View.GONE);
                                                        avaialable14TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts14TVID.setVisibility(View.VISIBLE);
                                                        availableCourts14TVID.setVisibility(View.VISIBLE);
                                                        avaialable14TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FifthRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable14TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime14TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts14TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts14TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable14TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 14) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime15TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts15TVID.setVisibility(View.GONE);
                                                        availableCourts15TVID.setVisibility(View.GONE);
                                                        avaialable15TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts15TVID.setVisibility(View.VISIBLE);
                                                        availableCourts15TVID.setVisibility(View.VISIBLE);
                                                        avaialable15TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            FifthRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable15TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime15TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts15TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts15TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable15TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 15) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime16TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts16TVID.setVisibility(View.GONE);
                                                        availableCourts16TVID.setVisibility(View.GONE);
                                                        avaialable16TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts16TVID.setVisibility(View.VISIBLE);
                                                        availableCourts16TVID.setVisibility(View.VISIBLE);
                                                        avaialable16TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SixthRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable16TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime16TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts16TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts16TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable16TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 16) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime17TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts17TVID.setVisibility(View.GONE);
                                                        availableCourts17TVID.setVisibility(View.GONE);
                                                        avaialable17TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts17TVID.setVisibility(View.VISIBLE);
                                                        availableCourts17TVID.setVisibility(View.VISIBLE);
                                                        avaialable17TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SixthRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable17TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime17TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts17TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts17TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable17TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 17) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime18TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts18TVID.setVisibility(View.GONE);
                                                        availableCourts18TVID.setVisibility(View.GONE);
                                                        avaialable18TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts18TVID.setVisibility(View.VISIBLE);
                                                        availableCourts18TVID.setVisibility(View.VISIBLE);
                                                        avaialable18TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SixthRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable18TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime18TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts18TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts18TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable18TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 18) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime19TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts19TVID.setVisibility(View.GONE);
                                                        availableCourts19TVID.setVisibility(View.GONE);
                                                        avaialable19TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts19TVID.setVisibility(View.VISIBLE);
                                                        availableCourts19TVID.setVisibility(View.VISIBLE);
                                                        avaialable19TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SeventhRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable19TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime19TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts19TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts19TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable19TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 19) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime20TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts20TVID.setVisibility(View.GONE);
                                                        availableCourts20TVID.setVisibility(View.GONE);
                                                        avaialable20TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts20TVID.setVisibility(View.VISIBLE);
                                                        availableCourts20TVID.setVisibility(View.VISIBLE);
                                                        avaialable20TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SeventhRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable20TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime20TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts20TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts20TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable20TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 20) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime21TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts21TVID.setVisibility(View.GONE);
                                                        availableCourts21TVID.setVisibility(View.GONE);
                                                        avaialable21TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts21TVID.setVisibility(View.VISIBLE);
                                                        availableCourts21TVID.setVisibility(View.VISIBLE);
                                                        avaialable21TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            SeventhRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable21TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime21TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts21TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts21TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable21TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 21) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime22TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts22TVID.setVisibility(View.GONE);
                                                        availableCourts22TVID.setVisibility(View.GONE);
                                                        avaialable22TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts22TVID.setVisibility(View.VISIBLE);
                                                        availableCourts22TVID.setVisibility(View.VISIBLE);
                                                        avaialable22TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            EigthRowFirstColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable22TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime22TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts22TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts22TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable22TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                            ...
                                                            if (!slotdisable) {
                                                                if (courtEnable != 0) {
                                                                    ...
                                                                    if (roweigthCourtsLLID.getVisibility() == View.GONE) {
                                                                        // SharedPreference.setPreference(AvailableListFragment.this, "KEY_EIGTH_ROW", "VISIBLE");
                                                                        int kk = (Integer) v.getTag();
                                                                        courtDetailsDataLocal1 = _singleAvailbleListData.get(kk).get_courtDetails();
                                                ...
                                                if (i == 22) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime23TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts23TVID.setVisibility(View.GONE);
                                                        availableCourts23TVID.setVisibility(View.GONE);
                                                        avaialable23TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts23TVID.setVisibility(View.VISIBLE);
                                                        availableCourts23TVID.setVisibility(View.VISIBLE);
                                                        avaialable23TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            EigthRowSecondColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable23TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime23TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts23TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts23TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable23TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
                                                ...
                                                if (i == 23) {
                                                    ...
                                                    if (slotdisable) {
                                                        slottime24TVID.setTextColor(getResources().getColor(R.color.slot_time_in_slot_unavail));
                                                        ...
                                                        totalCourts24TVID.setVisibility(View.GONE);
                                                        availableCourts24TVID.setVisibility(View.GONE);
                                                        avaialable24TVID.setVisibility(View.INVISIBLE);
                                                    } else {
                                                        ...
                                                        totalCourts24TVID.setVisibility(View.VISIBLE);
                                                        availableCourts24TVID.setVisibility(View.VISIBLE);
                                                        avaialable24TVID.setVisibility(View.VISIBLE);
                                                    }
                                                    ...
                                                    if (_singleAvailbleListData.get(i).get_disbled()) {
                                                        ...
                                                        if (_singleAvailbleListData.get(i).get_availbleCourts() == 0) {
                                                            EigthRowThirdColumnLLID.setBackgroundColor(getResources().getColor(R.color.zero__avail_bg_color));
                                                            avaialable24TVID.setText(getResources().getString(R.string.un_available_slot));
                                                            slottime24TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            totalCourts24TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            availableCourts24TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                            avaialable24TVID.setTextColor(getResources().getColor(R.color.slot_inside_hide_text_color));
                                                        }
    ...
    protected Dialog createdDialog(int id) {
        switch (id) {
            ...
            //Set yesterday time milliseconds as date pickers minimum date
                /*DatePickerDialog datePickerDialog = new DatePickerDialog(AvailableListFragment.this, mDateSetListener, mYear, mMonth, mDay);
    ...
    private void currentDayAndDateSet(int mYeartemp, int monthOfYear, int mDaytemp, String dayarrow) {
        mYear = mYeartemp;
        mMonth = monthOfYear;
        mDay = mDaytemp;
    ...
    private void previousDateNamesFetch(int mYeartemp, int monthOfYear, int mDaytemp, String dayarrow) {
        mYear = mYeartemp;
        mMonth = monthOfYear;
        mDay = mDaytemp;
        try {
    ...
    private void nextDateNamesFetch(int mYeartemp, int monthOfYear, int mDaytemp, String dayarrow) {
        mYear = mYeartemp;
        mMonth = monthOfYear;
        mDay = mDaytemp;
        try {
    ...
    public void onBackPressed() {
        /*AlertDialog.Builder builder = new AlertDialog.Builder(AvailableListFragment.this);
